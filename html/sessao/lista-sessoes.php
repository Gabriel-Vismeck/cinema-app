...
<head>
    ...
    <title>Cinemáximo - Lista de Sessões</title>
    ...
    <link rel="stylesheet" href="/Projeto-Cinema/css/telas/lista-sessoes.css">
...
<body>
    <div class="conteudo">
        ...
        <h1 class="text-center my-4" style="color: var(--branco);">Lista de Sessões</h1>

        <a class="botao-componente" href="cadastro-sessao.php">Cadastrar sessão</a>
        ...
        <div class="lista fundo-cinza my-4">
            ...
            foreach ($sessoes as $linha) {
                echo "
                        <div class='linha'>
                            <div>{$linha["horarioInicio"]}</div>
                            <div>{$linha["titulo"]}</div>
                            <div>{$linha["nomeCinema"]}</div>
                            <div>{$linha["nomeSala"]}</div>
                            <div class='item-acoes'>
                                <a href='cadastro-sessao.php?sessao={$linha["idSessao"]}'>
                                    <i class='item-animacao fa-solid fa-pen'></i>
                                </a>
                                <a href='excluir-sessao.php?sessao={$linha["idSessao"]}'>
